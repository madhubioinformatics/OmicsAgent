...
> The complete multi-omics AI agent for bioinformatics. Built on the Claude API. Local-first. Reproducible. MIT licensed.

[![Python 3.10+](https://img.shields.io/badge/python-3.10+-blue?logo=python&logoColor=white)](#)
[![MIT License](https://img.shields.io/badge/license-MIT-green)](#)
[![Skills](https://img.shields.io/badge/omics_skills-15-orange)](#)
